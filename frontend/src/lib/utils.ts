...
export const ACCOUNT_TYPE_OPTIONS = [
  ...
  { value: "E2L",               label: "E2L" },
  { value: "E2L Eval",          label: "E2L Eval" },
  { value: "E2L OTP",           label: "E2L OTP" },
  { value: "EOD",               label: "EOD" },
  ...
  { value: "Fundamental Eval",  label: "Fundamental Eval" },
  { value: "Fundamental OTP",   label: "Fundamental OTP" },
  ...
  { value: "Premium Eval",      label: "Premium Eval" },
  { value: "Premium OTP",       label: "Premium OTP" },
