...
const FIRM = { firmId: "f08", firmName: "Elite Trader Funding", firmSlug: "elite-trader-funding", websiteUrl: "https://elitetraderfunding.com", trustpilot: 4.3 };
const CONFIGS = [
  { size: 25000,  label: "25K",  target: 1500, maxLoss: 1500, dailyLoss: 1000 },
...
async function scrape() {
  ...
  for (const cfg of CONFIGS) {
    ...
    if (!fee) { const known = { 25000: 155, 50000: 155, 100000: 255, 150000: 355 }; fee = known[cfg.size]; }

    plans.push(buildPlan({
      ...FIRM, planId: `etf-${cfg.label}`, accountSize: cfg.size,
      drawdownType: "intraday", drawdownAmount: cfg.maxLoss, dailyLossLimit: cfg.dailyLoss,
      profitTarget: cfg.target, profitSplit: 100, evalFee: fee, isOneTime: false,
