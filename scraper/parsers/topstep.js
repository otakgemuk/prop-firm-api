// Topstep parser
// Two account types:
//   - "Standard": monthly sub + $149 activation fee
//   - "No Activation": higher monthly, no activation fee
...
const KNOWN_NO_ACTIVATION = { 50000: 149, 100000: 249, 150000: 349 };
...
function parseFromText(text) {
  ...
  for (const cfg of CONFIGS) {
    // Standard type — monthly + activation fee
    ...
    // No Activation type — higher monthly, no activation
